...
class Dimensions {
  ...
  static double COMMON_PADDING_FOR_SCREEN = Dimensions.w20;
  ...
  static double getSafeAreaBottomHeight(BuildContext context) {
    return MediaQuery.of(context).padding.bottom;
  }

  static double getBottomButtonHeight(BuildContext context) {
    return 52.0 + MediaQuery.of(context).padding.bottom;
  }

  static double getImagePaddingFromTopHeight(BuildContext context) {
    return h20 + MediaQuery.of(context).padding.top;
  }

  static double getSafeAreaTopHeight(BuildContext context) {
  ...
  static double autumnScreenWidth(BuildContext context) {
    return MediaQuery.of(context).size.width;
  }

  static double autumnScreenHeight(BuildContext context) {
